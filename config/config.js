 ...
 */
exports.db = {
    connectString: 'mongodb://localhost/demo'
};
...
exports.projects = [
    {
        ...
        domain:  'localhost:3700',            // Project domain (each project should have it's own domain)
        name:    'Helpdesk',                  // Project name
        title:   'This is a test',            // Title for form
        letters: 'HH',                        // Short project code, used in ticket numbers
        responsible: 'helpheadheart@gmail.com',   // Email of responsible. Auto-creates user account with this email and sends password to it
        email: { // Mail parsing service
            login: "helpheadheart@gmail.com",     // todo Fill email login
            password: "12QW34er56TY",  // todo Fill email password
            host: 'imap.gmail.com',
            port: 993,
            tls: true,
            sign: 'Helpdesk',
